...
func (_m *MockInfinimeshCommonActionsRepo) DeleteRecursive(ctx context.Context, log *zap.Logger, from graph.InfinimeshGraphNode) error {
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, *zap.Logger, graph.InfinimeshGraphNode) error); ok {
		r0 = rf(ctx, log, from)
	} else {
		r0 = ret.Error(0)
	}
...
//   - log *zap.Logger
//   - from graph.InfinimeshGraphNode
func (_e *MockInfinimeshCommonActionsRepo_Expecter) DeleteRecursive(ctx interface{}, log interface{}, from interface{}) *MockInfinimeshCommonActionsRepo_DeleteRecursive_Call {
	return &MockInfinimeshCommonActionsRepo_DeleteRecursive_Call{Call: _e.mock.On("DeleteRecursive", ctx, log, from)}
}

func (_c *MockInfinimeshCommonActionsRepo_DeleteRecursive_Call) Run(run func(ctx context.Context, log *zap.Logger, from graph.InfinimeshGraphNode)) *MockInfinimeshCommonActionsRepo_DeleteRecursive_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockInfinimeshCommonActionsRepo_DeleteRecursive_Call) RunAndReturn(run func(context.Context, *zap.Logger, graph.InfinimeshGraphNode) error) *MockInfinimeshCommonActionsRepo_DeleteRecursive_Call {
	_c.Call.Return(run)
	return _c
}

// EnsureRootExists provides a mock function with given fields: _log, rdb, passwd
func (_m *MockInfinimeshCommonActionsRepo) EnsureRootExists(_log *zap.Logger, rdb *redis.Client, passwd string) error {
	ret := _m.Called(_log, rdb, passwd)
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(*zap.Logger, *redis.Client, string) error); ok {
		r0 = rf(_log, rdb, passwd)
	} else {
		r0 = ret.Error(0)
	}
...
//   - rdb *redis.Client
//   - passwd string
func (_e *MockInfinimeshCommonActionsRepo_Expecter) EnsureRootExists(_log interface{}, rdb interface{}, passwd interface{}) *MockInfinimeshCommonActionsRepo_EnsureRootExists_Call {
	return &MockInfinimeshCommonActionsRepo_EnsureRootExists_Call{Call: _e.mock.On("EnsureRootExists", _log, rdb, passwd)}
}

func (_c *MockInfinimeshCommonActionsRepo_EnsureRootExists_Call) Run(run func(_log *zap.Logger, rdb *redis.Client, passwd string)) *MockInfinimeshCommonActionsRepo_EnsureRootExists_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(*zap.Logger), args[1].(*redis.Client), args[2].(string))
	})
	return _c
}
...
func (_c *MockInfinimeshCommonActionsRepo_EnsureRootExists_Call) RunAndReturn(run func(*zap.Logger, *redis.Client, string) error) *MockInfinimeshCommonActionsRepo_EnsureRootExists_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *MockInfinimeshCommonActionsRepo) Link(ctx context.Context, log *zap.Logger, edge driver.Collection, from graph.InfinimeshGraphNode, to graph.InfinimeshGraphNode, lvl access.Level, role access.Role) error {
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, *zap.Logger, driver.Collection, graph.InfinimeshGraphNode, graph.InfinimeshGraphNode, access.Level, access.Role) error); ok {
		r0 = rf(ctx, log, edge, from, to, lvl, role)
	} else {
		r0 = ret.Error(0)
	}
...
//   - lvl access.Level
//   - role access.Role
func (_e *MockInfinimeshCommonActionsRepo_Expecter) Link(ctx interface{}, log interface{}, edge interface{}, from interface{}, to interface{}, lvl interface{}, role interface{}) *MockInfinimeshCommonActionsRepo_Link_Call {
	return &MockInfinimeshCommonActionsRepo_Link_Call{Call: _e.mock.On("Link", ctx, log, edge, from, to, lvl, role)}
}

func (_c *MockInfinimeshCommonActionsRepo_Link_Call) Run(run func(ctx context.Context, log *zap.Logger, edge driver.Collection, from graph.InfinimeshGraphNode, to graph.InfinimeshGraphNode, lvl access.Level, role access.Role)) *MockInfinimeshCommonActionsRepo_Link_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(*zap.Logger), args[2].(driver.Collection), args[3].(graph.InfinimeshGraphNode), args[4].(graph.InfinimeshGraphNode), args[5].(access.Level), args[6].(access.Role))
	})
	return _c
}
...
func (_c *MockInfinimeshCommonActionsRepo_Link_Call) RunAndReturn(run func(context.Context, *zap.Logger, driver.Collection, graph.InfinimeshGraphNode, graph.InfinimeshGraphNode, access.Level, access.Role) error) *MockInfinimeshCommonActionsRepo_Link_Call {
	_c.Call.Return(run)
	return _c
}

// ListOwnedDeep provides a mock function with given fields: ctx, log, from
func (_m *MockInfinimeshCommonActionsRepo) ListOwnedDeep(ctx context.Context, log *zap.Logger, from graph.InfinimeshGraphNode) (*access.Nodes, error) {
	ret := _m.Called(ctx, log, from)
	...
	var r0 *access.Nodes
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *zap.Logger, graph.InfinimeshGraphNode) (*access.Nodes, error)); ok {
		return rf(ctx, log, from)
	}
	if rf, ok := ret.Get(0).(func(context.Context, *zap.Logger, graph.InfinimeshGraphNode) *access.Nodes); ok {
		r0 = rf(ctx, log, from)
	} else {
		if ret.Get(0) != nil {
...
//   - log *zap.Logger
//   - from graph.InfinimeshGraphNode
func (_e *MockInfinimeshCommonActionsRepo_Expecter) ListOwnedDeep(ctx interface{}, log interface{}, from interface{}) *MockInfinimeshCommonActionsRepo_ListOwnedDeep_Call {
	return &MockInfinimeshCommonActionsRepo_ListOwnedDeep_Call{Call: _e.mock.On("ListOwnedDeep", ctx, log, from)}
}

func (_c *MockInfinimeshCommonActionsRepo_ListOwnedDeep_Call) Run(run func(ctx context.Context, log *zap.Logger, from graph.InfinimeshGraphNode)) *MockInfinimeshCommonActionsRepo_ListOwnedDeep_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(*zap.Logger), args[2].(graph.InfinimeshGraphNode))
	})
	return _c
...
func (_c *MockInfinimeshCommonActionsRepo_ListOwnedDeep_Call) RunAndReturn(run func(context.Context, *zap.Logger, graph.InfinimeshGraphNode) (*access.Nodes, error)) *MockInfinimeshCommonActionsRepo_ListOwnedDeep_Call {
	_c.Call.Return(run)
	return _c
}
