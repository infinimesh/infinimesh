...
func (_m *MockShadowServiceClient) StreamShadow(ctx context.Context, in *shadow.StreamShadowRequest, opts ...grpc.CallOption) (node.ShadowService_StreamShadowClient, error) {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
	...
	var r0 node.ShadowService_StreamShadowClient
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *shadow.StreamShadowRequest, ...grpc.CallOption) (node.ShadowService_StreamShadowClient, error)); ok {
		return rf(ctx, in, opts...)
	}
	if rf, ok := ret.Get(0).(func(context.Context, *shadow.StreamShadowRequest, ...grpc.CallOption) node.ShadowService_StreamShadowClient); ok {
		r0 = rf(ctx, in, opts...)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(node.ShadowService_StreamShadowClient)
		}
	}
...
func (_c *MockShadowServiceClient_StreamShadow_Call) Return(_a0 node.ShadowService_StreamShadowClient, _a1 error) *MockShadowServiceClient_StreamShadow_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockShadowServiceClient_StreamShadow_Call) RunAndReturn(run func(context.Context, *shadow.StreamShadowRequest, ...grpc.CallOption) (node.ShadowService_StreamShadowClient, error)) *MockShadowServiceClient_StreamShadow_Call {
	_c.Call.Return(run)
	return _c
}

// StreamShadowSync provides a mock function with given fields: ctx, in, opts
func (_m *MockShadowServiceClient) StreamShadowSync(ctx context.Context, in *shadow.StreamShadowRequest, opts ...grpc.CallOption) (node.ShadowService_StreamShadowSyncClient, error) {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
	...
	var r0 node.ShadowService_StreamShadowSyncClient
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *shadow.StreamShadowRequest, ...grpc.CallOption) (node.ShadowService_StreamShadowSyncClient, error)); ok {
		return rf(ctx, in, opts...)
	}
	if rf, ok := ret.Get(0).(func(context.Context, *shadow.StreamShadowRequest, ...grpc.CallOption) node.ShadowService_StreamShadowSyncClient); ok {
		r0 = rf(ctx, in, opts...)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(node.ShadowService_StreamShadowSyncClient)
		}
	}
...
//   - in *shadow.StreamShadowRequest
//   - opts ...grpc.CallOption
func (_e *MockShadowServiceClient_Expecter) StreamShadowSync(ctx interface{}, in interface{}, opts ...interface{}) *MockShadowServiceClient_StreamShadowSync_Call {
	return &MockShadowServiceClient_StreamShadowSync_Call{Call: _e.mock.On("StreamShadowSync",
		append([]interface{}{ctx, in}, opts...)...)}
}

func (_c *MockShadowServiceClient_StreamShadowSync_Call) Run(run func(ctx context.Context, in *shadow.StreamShadowRequest, opts ...grpc.CallOption)) *MockShadowServiceClient_StreamShadowSync_Call {
	_c.Call.Run(func(args mock.Arguments) {
		variadicArgs := make([]grpc.CallOption, len(args)-2)
		for i, a := range args[2:] {
			if a != nil {
...
func (_c *MockShadowServiceClient_StreamShadowSync_Call) Return(_a0 node.ShadowService_StreamShadowSyncClient, _a1 error) *MockShadowServiceClient_StreamShadowSync_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockShadowServiceClient_StreamShadowSync_Call) RunAndReturn(run func(context.Context, *shadow.StreamShadowRequest, ...grpc.CallOption) (node.ShadowService_StreamShadowSyncClient, error)) *MockShadowServiceClient_StreamShadowSync_Call {
	_c.Call.Return(run)
	return _c
}
