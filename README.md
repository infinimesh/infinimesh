...
## Project status
Infinimesh is under heavy development. If you feel really adventurous, check out [InfiniDev branch](https://github.com/InfiniteDevices/infinimesh/tree/infinidev), there is the place all magic is happen - with unexpected results.
